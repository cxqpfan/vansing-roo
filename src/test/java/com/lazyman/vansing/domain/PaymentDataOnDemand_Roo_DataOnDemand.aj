...
privileged aspect PaymentDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    CourseDataOnDemand PaymentDataOnDemand.courseDataOnDemand;
    
    @Autowired
    StudentDataOnDemand PaymentDataOnDemand.studentDataOnDemand;
    ...
    public void PaymentDataOnDemand.setCourse(Payment obj, int index) {
        Course course = courseDataOnDemand.getRandomCourse();
        obj.setCourse(course);
    }
    
    public void PaymentDataOnDemand.setFee(Payment obj, int index) {
        int fee = index;
        obj.setFee(fee);
    }
    
    public void PaymentDataOnDemand.setMemo(Payment obj, int index) {
    ...
    public void PaymentDataOnDemand.setPayDate(Payment obj, int index) {
    ...
    public void PaymentDataOnDemand.setStudent(Payment obj, int index) {
