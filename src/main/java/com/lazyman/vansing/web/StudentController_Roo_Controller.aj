...
import com.lazyman.vansing.web.StudentController;
...
privileged aspect StudentController_Roo_Controller {
    ...
    void StudentController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("student_enrolldate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
